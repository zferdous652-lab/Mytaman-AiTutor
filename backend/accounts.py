...
USER_OWNED_COLLECTIONS = [
    ...
    # Added when billing merged in: a removed learner's paid course unlocks have to go
    # with them. Left behind they misreport what has been sold, and would silently
    # re-grant access if that user id were ever reissued.
