...
const dict = {
  en: {
    ...
    joining_as_sub: "Pick the account you need. You can always invite the other side afterwards.",
    join_parent: "Parent",
    join_parent_desc: "Follow your child's progress and choose their Tutor Packs.",
    join_parent_note: "You'll add your child from inside the portal.",
    join_student: "Student",
    join_student_desc: "Start learning straight away — notes, quizzes and your AI tutor.",
    join_student_note: "No email needed, just a student ID.",
    // dashboard shared
    overview: "Overview",
  ...
  bm: {
    ...
    joining_as: "Menyertai sebagai…",
    joining_as_sub: "Pilih akaun yang anda perlukan. Anda boleh menjemput pihak satu lagi kemudian.",
    join_parent: "Ibu bapa",
    join_parent_desc: "Ikuti kemajuan anak anda dan pilih Pek Tutor untuk mereka.",
    join_parent_note: "Anda akan menambah anak anda dari dalam portal.",
    join_student: "Pelajar",
    join_student_desc: "Mula belajar terus — nota, kuiz dan tutor AI anda.",
    join_student_note: "Tiada e-mel diperlukan, cuma ID pelajar.",
