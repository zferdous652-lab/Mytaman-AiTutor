...
const dict = {
  en: {
    ...
    hero_sub:
      "Lv99.ai blends pre-built KSSM curriculum with adaptive AI that generates summaries, quizzes, flashcards and mind maps — in English and Bahasa Melayu.",
    ...
    about_body:
      "Lv99.ai is building the operating system for Malaysian secondary education. Our AI Tutor turns curriculum PDFs into interactive learning packs used by students and reviewed by educators.",
  ...
  bm: {
    ...
    hero_sub:
      "Lv99.ai menggabungkan kurikulum KSSM sedia ada dengan AI adaptif — menjana ringkasan, kuiz, kad imbas dan peta minda dalam Bahasa Melayu dan Inggeris.",
    ...
    about_body:
      "Lv99.ai membina sistem operasi untuk pendidikan menengah Malaysia. AI Tutor kami menukar PDF kurikulum kepada pek pembelajaran interaktif.",
