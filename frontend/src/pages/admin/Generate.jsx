...
import { Plus, X, CheckCircle2, FileEdit, ListChecks, Trash2, MoreVertical, XCircle, Pencil, Copy, Sparkles, FileText } from "lucide-react";
...
// ---------- Mind map builder (AI/hand-authored HTML fragment, rendered live) ----------
  ...
  return (
    <div className="space-y-3" data-testid="mindmap-builder">
      ...
      <textarea
        ...
        placeholder="Mind map HTML appears here after AI Generate — edit freely before saving..."
